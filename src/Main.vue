...
<template>
  <main>
    ...
    <div :class="color">這是一段文字：{{ color }}</div> <!-- 與 class 屬性連動 -->
    <hr>
    ...
    <div :class="option">使用者選擇的顏色是：{{ option }}</div>
  </main>
</template>
